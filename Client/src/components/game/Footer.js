...
export default function Footer( {
  ...
  return (
    ...
    {(footerType === 'upgrade') && (
      <UpgradeView provProp={{... provProp}} onBuyUpgrade={onBuyUpgrade} session={session} slotIndex={slotIndex} /> 
    )}
    </>
  );
}
...
function UpgradeView({provProp, onBuyUpgrade, session, slotIndex}) {
